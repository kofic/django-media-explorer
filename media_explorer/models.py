...
class Element(Base):
    ...
    s3_privacy = models.CharField(max_length=10,blank=True,null=True,default="public")
    ...
    thumbnail_s3_privacy = models.CharField(max_length=10,blank=True,null=True,default="public")
